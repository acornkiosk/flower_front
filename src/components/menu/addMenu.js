    ...
    return(
        <Container>
            ...
            <div className="d-flex justify-content-around">
                ...
                <div className="text-bg-light p-3 d-flex justify-content-center text-bg-light p-3">
                    
                    <Form.Group className="mb-3">
                    <div className="d-flex justify-content-center text-bg-light p-3">
                        {!previewImage ?    
                        <svg onClick={()=>{ fileInputRef.current.click();}} width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Form.Control as="textarea" name="description" placeholder="상세설명" />
                </Form.Group>
