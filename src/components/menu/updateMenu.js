...
function UpdateMenu(){
    ...
    const getMenuImage =(img_name)=>{
        ...
        // axios.post("upload/images",requestData,
        // {headers: { "Content-Type": "application/json" }})
        // .then(res=>{
           
        //     setGetViewImage(res.data);
        // })
    }
    const menuUpdate =(e)=>{
        e.preventDefault();
        ...
        <Container>
                ...
                <div className="d-flex justify-content-center mx-auto ">
                    <div>
                        ...
                        <Form.Label >이미지 선택하기</Form.Label>
                            ...
                            :
                            (!previewImage ? <img src={getViewImage} onClick={()=>{ fileInputRef.current.click();}} style={previewStyle} /> :
            ...
            <div>
                ...
                <div className="d-flex justify-content-center ">
                    <Button type="submit" style={{marginRight:'15px'}} >수정</Button>
                    <Button variant="btn btn-danger" style={{marginLeft:'15px'}} onClick={deleteMenu}>삭제</Button>
                </div>
            </div>
            </Form>
